  ...
  return (
    <div className="mx-auto flex min-h-dvh w-full max-w-xl flex-col px-5 pb-16">
      ...
      <div className="pt-10 text-center">
        ...
        <p className="mx-auto mt-3 max-w-sm text-sm leading-relaxed text-parchment-500">
      ...
      <div className="mt-10 space-y-4">
        ...
        >
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-gold-600/50 bg-ink-850 text-gold-400">
