  ...
  return (
    <article className="mx-auto w-full max-w-[800px] px-5 py-14 sm:py-20">
      ...
      <header className="mt-8 border-b border-ink-800 pb-8">
        <h1 className="font-display text-4xl font-semibold text-parchment-100 sm:text-5xl">Privacy Policy</h1>
        <p className="mt-4 text-base leading-relaxed text-parchment-500">How The Lexicon handles Discord authentication, profile information, optional location sharing, analytics, cookies, and beta community data.</p>
      </header>
