  ...
  return (
    <article className="mx-auto w-full max-w-[800px] px-5 py-14 sm:py-20">
      ...
      <header className="mt-8 border-b border-ink-800 pb-8">
        <h1 className="font-display text-4xl font-semibold text-parchment-100 sm:text-5xl">Terms of Service</h1>
        <p className="mt-4 text-base leading-relaxed text-parchment-500">Concise beta terms for using The Lexicon tabletop gaming community platform, including user content ownership and venue and event listing expectations.</p>
      </header>
