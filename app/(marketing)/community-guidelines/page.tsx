  ...
  return (
    <article className="mx-auto w-full max-w-[800px] px-5 py-14 sm:py-20">
      ...
      <header className="mt-8 border-b border-border-muted pb-8">
        <h1 className="font-display text-4xl font-semibold text-text sm:text-5xl">Community Guidelines</h1>
        <p className="mt-4 text-base leading-relaxed text-text-muted">Community expectations for respectful tabletop gaming discussion, hobby discovery, venue listings, and events on The Lexicon.</p>
      </header>
